...
def verify_user_access(url_user_id: str, token_user_id: str) -> None:
    ...
    Args:
        url_user_id: The user_id from the URL path parameter
        token_user_id: The user_id extracted from the JWT token

    Raises:
        HTTPException: 403 Forbidden if user_id does not match
    """
