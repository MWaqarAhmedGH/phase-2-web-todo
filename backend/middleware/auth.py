...
def verify_token(token: str) -> dict:
    ...
    try:
        ...
        # Disable audience and issuer verification as Better Auth may set varying values
        payload = jwt.decode(
            token,
            signing_key.key,
...
def get_current_user(
    ...
    Usage:
        ...
        def protected_route(user: Annotated[AuthenticatedUser, Depends(get_current_user)]):
